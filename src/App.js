import './App.css';
import RenderIdCard from './components/Id-card';
import Greeting from './components/Greetings/index.js';
...
function App() {
  return (
    <div className="App">
      <RenderIdCard user={idCard[0]}></RenderIdCard>
      <RenderIdCard user={idCard[1]}></RenderIdCard>
      ...
      <Rating>4</Rating>
      <Rating>5</Rating>
      <DriverCard name="Travis Kalanick" rating={4.2} img="https://si.wsj.net/public/resources/images/BN-TY647_37gql_OR_20170621052140.jpg?width=620height=428" car={{ model: "Toyota Corolla Altis", licensePlate: "CO42DE"}}/>
